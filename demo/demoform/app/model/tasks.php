...
/**
 * Tasks 封装来自 tasks 数据表的记录及领域逻辑
 */
class Tasks extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                'owner' => array(QDB::BELONGS_TO => 'Users', 'source_key' => 'owner_id'),
            ...
            (
                'subject' => array
                (
                    array('not_empty', 'subject不能为空'),
                    array('max_length', 200, 'subject不能超过 200 个字符'),

                ),

                // 'completed_at' => array
                // (
                //     array('is_int', 'completed_at必须是一个整数'),

                // ),

                // 'owner_id' => array
                // (
                //     array('is_int', 'owner_id必须是一个整数'),
